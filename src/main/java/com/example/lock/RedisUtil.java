...
public class RedisUtil {
     ...
     *
     * @param key   键
     * @param index 索引 当 index >= 0 时 {0:表头, 1:第二个元素} 当 index < 0 时 {-1:表尾, -2:倒数第二个元素}
     * @return 值
     */
     ...
     *
     * @param key   键
     * @param count 如果 count == 0 则删除 list 中所有值为 value 的元素 如果 count > 0 则删除 list 中最左边那个值为 value 的元素 如果 count < 0 则删除
     *              list 中最右边那个值为 value 的元素
     * @param value
     * @return
     */
